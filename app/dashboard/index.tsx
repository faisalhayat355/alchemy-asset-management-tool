...
const useStyles = makeStyles({
    ...
    divIcon: {
        borderRadius:'5px',background:'#3b82f6',height:'3vh',width:'25%',
        marginBottom:'0.5rem',marginTop:'-1.5rem',marginLeft:'1rem',paddingTop:'0.7rem',
        paddingLeft:'0.8rem',paddingRight:'1rem',paddingBottom:'1rem',color:'white',
        transition: "width 2s, height 2s, transform 2s",
        "&:hover": {
            borderRadius:'5px',background:'#1e40af',height:'3vh',width:'25%',
            marginBottom:'0.5rem',marginTop:'-1.5rem',marginLeft:'1rem',paddingTop:'0.7rem',
            paddingLeft:'0.8rem',paddingRight:'1rem',paddingBottom:'1rem',transform: "rotate(180deg)",
        },
    },
    divIcon2: {
        borderRadius:'5px',background:'#991b1b',height:'3vh',width:'25%',
        marginBottom:'0.5rem',marginTop:'-1.5rem',marginLeft:'1rem',paddingTop:'0.7rem',
        paddingLeft:'0.8rem',paddingRight:'1rem',paddingBottom:'1rem',color:'white',
        transition: "width 2s, height 2s, transform 2s",
        "&:hover": {
            borderRadius:'5px',background:'#450a0a',height:'3vh',width:'25%',
            marginBottom:'0.5rem',marginTop:'-1.5rem',marginLeft:'1rem',paddingTop:'0.7rem',
            paddingLeft:'0.8rem',paddingRight:'1rem',paddingBottom:'1rem',transform: "rotate(180deg)",
    ...
    divIcon3: {
        borderRadius:'5px',background:'#86198f',height:'3vh',width:'25%',
        marginBottom:'0.5rem',marginTop:'-1.5rem',marginLeft:'1rem',paddingTop:'0.7rem',
        paddingLeft:'0.8rem',paddingRight:'1rem',paddingBottom:'1rem',color:'white',
        transition: "width 2s, height 2s, transform 2s",
        "&:hover": {
            borderRadius:'5px',background:'#701a75',height:'3vh',width:'25%',
            marginBottom:'0.5rem',marginTop:'-1.5rem',marginLeft:'1rem',paddingTop:'0.7rem',
            paddingLeft:'0.8rem',paddingRight:'1rem',paddingBottom:'1rem',transform: "rotate(180deg)",
            ...
            <Grid container sx={{padding:'0.7rem',alignItems:'center'}}>
               ...
               <Grid item xs={3} mt={1.5}>
                    <Paper className={classes.paper} elevation={0} >
                       <Grid container> 
                       <Grid item xs={4}>
                       <div className={classes.divIcon}> <SettingsIcon/></div>
                       </Grid>
                ...
                <Grid item xs={3} mt={1.5}>
                    <Paper className={classes.paper} elevation={0} >
                       <Grid container> 
                       <Grid item xs={4}>
                       <div className={classes.divIcon2}><EqualizerIcon/></div>
                       </Grid>
                        <Grid item xs={8} sx={{display:'flex',justifyContent:'flex-end'}}>
                ...
                <Grid item xs={3} mt={1.5}>
                    <Paper className={classes.paper} elevation={0} >
                       <Grid container> 
                       <Grid item xs={4}>
                       <div className={classes.divIcon3}><ShoppingCartIcon/></div>
                       </Grid>
                        <Grid item xs={8} sx={{display:'flex',justifyContent:'flex-end'}}>
                ...
                <Grid item xs={7}>
                    <Paper elevation={0} className={classes.assetvalue}>
                        <Grid container>
                            ...
                            <Grid item xs={6.8} style={{display:'flex'}}>
                                <div style={{background:"#3b82f6",color:'white',padding:'0.4rem',borderRadius:'5px',fontSize:'0.9rem'}}>Assets Due</div>
                                <div style={{background:"#a21caf",marginLeft:'0.7rem',color:'white',padding:'0.4rem',borderRadius:'5px',fontSize:'0.9rem'}}>Maintenance Due</div>
                                <div style={{background:"#ef4444",marginLeft:'0.7rem',color:'white',padding:'0.4rem',borderRadius:'5px',fontSize:'0.9rem'}}>Warranty Expiring</div>
                            </Grid>
                            <Grid item xs={11.62} mt={0.5} sx={{display:"flex",justifyContent:'flex-end'}}>
                            <div style={{width:'20.85%',background:"#facc15",marginLeft:'0.7rem',color:'white',padding:'0.4rem',borderRadius:'5px',fontSize:'0.9rem'}}>Lease Expiring</div>
                            </Grid>
                        </Grid>
