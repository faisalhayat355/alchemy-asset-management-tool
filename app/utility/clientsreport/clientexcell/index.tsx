...
const ClientReportExcellDownload = ({users}:AssetsProps) => {
  ...
  return (
    <Typography variant="subtitle1" onClick={(e) => exportToCSV(users, fileName)}>Excell</Typography>
  )
}

export default ClientReportExcellDownload
