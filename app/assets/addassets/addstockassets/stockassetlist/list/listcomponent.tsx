...
import StockAssetInfoComponent from '../info';

  
  type AssetsProps = {
      users: Array<IAssets>;
    };
const StockListAssetComponent = ({users}:AssetsProps) => {
          ...
          ?.map((items:any, index: number) => {
            return (
              <Typography key={index}>
                 <StockAssetInfoComponent items={items}/>
              </Typography>
            );
          })}
      </Grid>
...
export default StockListAssetComponent
