    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
          <Box style={{marginTop:'1.2rem'}}>
            <Grid container spacing={2} sx={{background:'white',borderRadius:"8px 8px 0px 0px",borderTop:'3px solid #1F7DA9',paddingLeft:'1rem',paddingRight:'1rem',paddingTop:'0.8rem',paddingBottom:'1rem',width:'96%',marginLeft:'1.3rem',alignItems:'center',boxShadow: "rgba(99, 99, 99, 0.2) 0px 2px 8px 0px"}}>
