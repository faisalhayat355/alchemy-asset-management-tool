      ...
      <Grid item xs={12}>
        ...
        <Tooltip title="Account settings">
          <IconButton onClick={handleClick} size="small" 
            ...
            <Avatar sx={{ width: 32, height: 32 }} alt="Image not Found" src="/images/profile2.jpg" />
          ...
          sx: { overflow: "visible",
            ...
            "&:before": {content: '""', display: "block", position: "absolute",
              ...
              <MenuItem onClick={handleClose}>
                <Avatar sx={{ width: 32, height: 32 }} alt="Image not Found" src="/images/profile2.jpg"/> Profile
              </MenuItem>
              <MenuItem onClick={handleClose}>
                <Avatar sx={{ width: 32, height: 32 }} alt="Image not Found" src="/images/profile2.jpg"/> My account
              </MenuItem>
              <Divider />
              <MenuItem onClick={handleClose}>
                <ListItemIcon>
