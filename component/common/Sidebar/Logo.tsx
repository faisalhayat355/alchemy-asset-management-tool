    ...
    <div style={{ display: "flex", alignItems: "center", paddingBottom: "1rem" }}>
      ...
      <div>
        <div onClick={handleMenu}>
          ...
          TransitionProps={{ timeout: 600 }} placement="right-start"><ClearAllIcon style={{marginTop:'1rem',marginLeft:'1rem',color:'#1F7DA9',cursor:'pointer',fontSize:'1.7rem'}}/> </Tooltip>}
        </div>
      </div>
    </div>
  );
