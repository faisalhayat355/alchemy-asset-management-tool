...
function AssetSidebarComponent() {
  ...
  return (
    <div>
      <Sidebar
        ...
        style={{ height: "83%", position: "absolute" }}
        collapsed={collapsed}
        toggled={toggled}
      ...
      >
        <main>
          ...
          <Menu >
            ...
            <SubMenu defaultOpen label={"Professors"} icon={<RiFolder2Line />} style={{marginRight:'2rem'}}>
...
export default AssetSidebarComponent;
